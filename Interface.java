...
class DEPOSIT_WITHDRAW implements ActionListener{
	...
	JButton exitButton,subButton,mulButton,dzButton;
	JButton dotButton, entButton, delButton, clrButton, negButton;
	JPanel panel;
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource()==entButton) {
			try
			{
				...
				List<Integer> l_pass=new ArrayList<Integer>();
				List<Double> l_bal=new ArrayList<Double>();
